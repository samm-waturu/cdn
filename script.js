...
! function(e) {
    ...
    var t = 0,
        ...
        r = {
            init: function() {
                this.marquee(), this.tooltip(), this.fontDialog(), this.modelTabs(), this.bookmark(), this.negativePrompt(), this.imageGenerationSidebar(), this.rangeSlider(), this.quantity(), this.selectModel(), this.anchor(), this.aiChatBot__chat(), this.aiChatBotOptions(), this.aiChatBotTextareaHeight(), this.billingProgress(), this.inputFileOnChange(), this.optionsList(), this.report(), this.follow(), this.copyLink(), this.galleryIsotope(), this.imageLightbox(), this.like(), this.accordion(), this.animatedText(), this.movingSubMenuForLeftPanel(), this.panelResize(), this.navBarItems(),  this.navSubMenu(), this.imgToSVG(), this.BgImg(), this.popupMobile()
            },
            marquee: function() {
            ...
            popupMobile: function() {
                if (window.matchMedia("(max-width: 767px)").matches) {
                    var t = e(".style_fn_wrapper").width();
            ...
            fontDialog: function() {
                ...
                e(".font__trigger").off().on("click", function() {
                    ...
                    return e(".fn__chat_font_size_style").remove(), e("body").append('<style type="text/css" class="fn__chat_font_size_style">custom_typing h3,.fn__chatbot .chat{font-size: ' + e("#font_size").find(":selected").val() + "px;}</style>"), t.removeClass("opened"), !1
                })
            },
            modelTabs: function() {
                e(".style_fn_models .fn__tabs a").off().on("click", function() {
                    var t = e(this);
                    if (!t.hasClass("active") && !o) {
                        o = !0, t.siblings().removeClass("active"), t.addClass("active");
                        var a = t.closest(".style_fn_models");
            ...
            negativePrompt: function() {
                e("#negative_prompt").on("change", function() {
                    this.checked ? e(".style_fn_image_generation_page .exclude_area").slideDown(200) : e(".style_fn_image_generation_page .exclude_area").slideUp(200)
                })
            },
            imageGenerationSidebar: function() {
                e(".style_fn_image_generation_page .sidebar__trigger").off().on("click", function() {
                    return e(".style_fn_wrapper").toggleClass("fn__has_sidebar"), !1
                })
            },
            ...
            anchor: function() {
                e(".style_fn_doc_page .docsidebar li.menu-item-has-children > a").off().on("click", function() {
                    return e(this).siblings("ul").slideToggle(), !1
                }), e().onePageNav && e(".style_fn_doc_page .docsidebar > ul").onePageNav()
            },
            aiChatBot__chat: function() {
                e("#fn__chat_textarea").length && !e(".style_fn_intro").length && e("#fn__chat_textarea").focus(), e("#fn__chat_textarea").keypress(function(t) {
                    ...
                    if (!("" === o || t.hasClass("disabled"))) {
                        ...
                        return a.val(""), a.siblings(".fn__hidden_textarea").val(""), r.aiChatBotTextareaHeight(), e(".style_fn_intro").length ? e("html, body").animate({
                            scrollTop: a.offset().top - e(window).height() + 100
                        }) : e("html, body").animate({
                            scrollTop: e(document).height() - e(window).height()
                        }), a.customMoveCursorToEnd(), r.customChat(), !1
                    }
                })
            },
            customChat: function() {
                ...
                var n = {
                    welcome: {
                        ...
                        text: "<p>custom was founded in 2017. The company began working with the first customers, giving them the opportunity to purchase high-quality HTML templates.</p><p>The company’s products began to grow in terms of complexity and aesthetics. custom currently has a wide range of HTML templates, WordPress themes, WordPress plugins, Photoshop projects; paid and absolutely free products.</p><p>Design projects are unique and aesthetically pleasing based on customer requirements. Visit our website to get acquainted with our products. Thank you so much for being with us.</p>",
                        append: !0
                    },
                    about: {
                        type: "text",
                        description: "some information about the custom team",
                        text: "<p>custom was founded in 2017. The company began working with the first customers, giving them the opportunity to purchase high-quality HTML templates.</p><p>The company’s products began to grow in terms of complexity and aesthetics. custom currently has a wide range of HTML templates, WordPress themes, WordPress plugins, Photoshop projects; paid and absolutely free products.</p><p>Design projects are unique and aesthetically pleasing based on customer requirements. Visit our website to get acquainted with our products. Thank you so much for being with us.</p>",
                        append: !0
                    },
                    website: {
                    ...
                    free: {
                        ...
                        append: !1,
                        url: "https://custom.com/freebies/"
                    },
                    doc: {
                        type: "url",
                        description: "visit online documentation for style HTML template",
                        append: !1,
                        url: "https://custom.com/work/envato/custom/html/style/doc"
                    },
                    support: {
                        type: "url",
                        description: "if you have any questions regarding style HTML template feel free and contact us by this command",
                        append: !1,
                        url: "https://themeforest.net/item/style-ai-html-dashboard-for-image-generation-chat-bot/46197058/support/contact"
                    },
                    purchase: {
                        type: "url",
                        description: "open the template description page on themeforest to purchase it",
                        append: !1,
                        url: "https://themeforest.net/item/style-ai-html-dashboard-for-image-generation-chat-bot/46197058"
                    },
                    youtube: {
                        type: "url",
                        description: "visit our youtube channel with video guides on our themes and templates",
                        append: !1,
                        url: "https://www.youtube.com/@customteam/videos"
                    },
                    pass: {
                        type: "password",
                        description: "if you want to get strong password I can generate it for you, write <custom_main>/pass 20</custom_main> to get a 20 character password",
                        append: !0
                    },
                    joke: {
                        type: "joke",
                ...
                if (1 === i) t = l;
                    ...
                    if ((f = /joke \d/i).test(d) && (p = d.split(" ")[1], d = "joke"), n.hasOwnProperty(d)) {
                        ...
                        if ("text" === g) t = m.text;
                            ...
                            t += "<custom_uselect>" + (v = r.escapeHTML(v)) + "</custom_uselect>"
                        } else if ("time" === g) {
                            var b, k = new Date,
                ...
                c && (t = '<p>I only understand some commands. Of course, this is a fixable problem. Buy this template and implement AI and that\'s it. Go to the template site where you can buy? Visit item\'s website: <a href="https://themeforest.net/user/custom/portfolio" target="_blank">style</a></p><p>Write <custom_main>/commands</custom_main> to list all available commands.'), a && (e(".fn__chat_comment button").addClass("disabled"), setTimeout(function() {
                    e(".fn__chatbot .chat__item.active").append('<div class="chat__box bot__chat"><div class="author"><span>custom Bot</span></div><div class="chat"><custom_typing><h3><span>Typing...</custom></h3></div></div>'), e(".style_fn_intro").length ? e("html, body").animate({
                        scrollTop: e("#fn__chat_textarea").offset().top - e(window).height() + 100
                    }) : e("html, body").animate({
                        scrollTop: e(document).height() - e(window).height()
                    })
                }, 100), setTimeout(function() {
                    e(".fn__chatbot .chat__item.active .chat__box.bot__chat:last-child .chat").html(t), e(".fn__chat_comment button").removeClass("disabled"), e(".style_fn_intro").length ? e("html, body").animate({
                        scrollTop: e("#fn__chat_textarea").offset().top - e(window).height() + 100
                    }) : e("html, body").animate({
                        scrollTop: e(document).height() - e(window).height()
                    })
            ...
            billingProgress: function() {
                e(".style_fn_user_billing .progress").each(function() {
                    var t = e(this);
                    t.waypoint({
                        handler: function() {
                            t.hasClass("active") || setTimeout(function() {
                                t.css("--custom-progress", t.data("percentage")), t.addClass("active")
                            }, 500)
                        },
                        offset: "90%"
                    })
            ...
            imageLightbox: function() {
                ...
                e(".fn__gallery_items .item").off().on("click", function() {
                    var n = e(this);
                    return n.data("id"), n.hasClass("select__ready") || (o.scrollTop(0), a = document.documentElement.style.getPropertyValue("--style-scroll-y"), t.css({
                        position: "fixed",
                        top: a
                    }), t.addClass("fn__lightbox_mode"), o.addClass("opened")), !1
                });
                var o = e(".style_fn_img_lightbox");
            ...
            accordion: function() {
                e(".style_fn_accordion").each(function() {
                    e(this).find(".opened .acc__content").slideDown(300)
                }), e(".style_fn_accordion .acc__header").on("click", function() {
                    var t = e(this),
                        a = t.closest(".acc__item"),
                        o = t.closest(".style_fn_accordion"),
            ...
            movingSubMenuForLeftPanel: function() {
                ...
                a.on("mouseenter", function() {
                    ...
                    var r = o.offset().top,
                        l = e(".style_fn_leftpanel .leftpanel_content").offset().top;
                    t.css({
                        top: r - l
                    }), n()
                }), n()
            ...
            panelResize: function() {
                var t = e("html");
                e(".style_fn_leftpanel .desktop_closer").off().on("click", function() {
                    return t.hasClass("panel-opened") ? (t.removeClass("panel-opened"), localStorage.custom_panel = "") : (t.addClass("panel-opened"), localStorage.custom_panel = "panel-opened"), !1
                }), e(".style_fn_leftpanel .mobile_closer").off().on("click", function() {
            ...
            navBarItems: function() {
                ...
                t.find(".user_opener").on("click", function(a) {
                    ...
                    return "light" === e("html").attr("data-style-skin") ? (e("html").attr("data-style-skin", "dark"), localStorage.mode = "dark") : (e("html").attr("data-style-skin", "light"), localStorage.mode = "light"), e(".bar__item_user,.bar__item_language,.bar__item_notification").removeClass("opened"), !1
                });
            ...
            navSubMenu: function() {
                e(".style_fn_leftpanel .menu-item-has-children > a").off().on("click", function() {
    ...
    e(document).ready(function() {
        r.init(), e(":root").css("--style-scroll-y", -1 * window.scrollY + "px"), setTimeout(function() {
            r.galleryIsotope()
        }, 500)
    }), e(window).on("resize", function() {
        r.popupMobile(), r.galleryIsotope()
    }), e(window).on("load", function() {
         r.galleryIsotope(), setTimeout(function() {
            r.galleryIsotope()
        }, 1e3)
